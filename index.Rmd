...
title: | 
    Eiendom investeringer:\
     Dynamiske krefter i priavte markeder.
author: Lyder Aleksander Mathisen 
college: NTNU Business School
university: Norwegian University of Science and Technology
university-logo: templates/ntnu_handelshoeyskolen_hoeyde_eng.pdf
university-logo-width: 5cm
submitted-text: A Master’s thesis submitted for the degree of
degree: MSc Economics and Business Management, Siviløkonom
degreedate: Norway, Trondheim 2021
abstract: |
  `r paste(readLines("front-and-back-matter/_abstract.Rmd"), collapse = '\n  ')`
acknowledgements: |
  `r paste(readLines("front-and-back-matter/_acknowledgements.Rmd"), collapse = '\n  ')`
dedication: NTNU Business School\ 
